...
<html>
<head>
    <title>共享农庄平台-修改密码</title>
    <link rel="stylesheet" type="text/css" href="CSS/HeaderandFooter.css" />
    <link rel="stylesheet" type="text/css" href="CSS/ModifyPassword.css" />
    <script type="text/javascript" src="Script/jquery-1.7.2.js"></script>
    <script type="text/javascript" src="Script/ModifyPassword.js"></script>
</head>
<body>
<%
...
<div class="Modify">
    ...
    <div class="form">
        <form action="modifyPassword">
            <input type="hidden" value="${requestScope.get("user")}" name="user">
            <div class="message">
                <label>输入新密码：</label>
                <input class="itxt" type="text" placeholder="请输入新密码"
                       autocomplete="off" tabindex="1" name="new_pwd" id="new_pwd"/>
                <br><br>
                <label>确认新密码：</label>
                <input class="itxt" type="password" placeholder="请再次输入"
                       autocomplete="off" tabindex="1" name="again_pwd" id="again_pwd"/>
                <br><br>
            </div>
            <div class="caozuo">
