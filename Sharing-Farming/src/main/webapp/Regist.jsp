    ...
    <div class="form">
        <form action="registServlet">
            <div class="message">
                ...
                <br>
                身份:&nbsp&nbsp&nbsp&nbsp&nbsp
                普通用户<input type="radio" name="status" value="0" checked="checked">&nbsp&nbsp&nbsp&nbsp
                代种人员<input type="radio" name="status" value="1">
                <br>
            </div>
            <div class="caozuo">
